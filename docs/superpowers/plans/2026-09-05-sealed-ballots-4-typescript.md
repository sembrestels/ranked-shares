...
export function tallyInputs(plan: ProofPlan, g: number): InputMap {
  ...
  return {
    costs_hash: d(pi[0]), state_in: d(pi[1]), state_out: d(pi[2]), done: d(pi[3]), t_hash_out: d(pi[4]), funded_count: d(pi[5]), funded_order_packed_in: d(pi[6]),
