"""Write reference/vectors/noir/fixture_<profile>_<scenario>.json (plan 1, Task 6, for the shape).

Usage, from `reference/`: python3 -m noir.tools.make_fixture --profile test|default [--out DIR]
`--out` defaults to `reference/vectors/noir/`.
...
VECTORS = os.path.join(os.path.dirname(os.path.abspath(__file__)), "..", "..", "vectors", "noir")
